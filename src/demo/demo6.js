...
// 实例化类
const objLoader = new OBJLoader()  //obj文件加载器
...
let path = './textures/objData/woman/'
let mtlName = 'female02.mtl'
let objName = 'female02.obj'

mtlLoader.setPath(path).load(mtlName, (mater) => {
    console.log(mater, 'mater');
    mater.preload()
    objLoader.setPath(path)
    objLoader.setMaterials(mater)
    objLoader.load(objName, event.onLoad, event.onProgress, event.onError)
